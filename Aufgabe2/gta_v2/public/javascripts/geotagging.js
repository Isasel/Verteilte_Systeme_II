...
var helper = new LocationHelper();
    helper.findLocation(initMap(helper.latitude,helper.longitude));

    //checks if 
    if(typeof helper === 'object' && helper !== null)
    {
        var lat  = document.getElementById("Add_Latitude");
        lat.value = helper.latitude;

        var lon = document.getElementById("Add_Longitude");
        lovalue = helper.longitude;
